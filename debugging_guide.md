...
1. Bestätige kurz was du verstanden hast: Fehler, Kontext
...
Beispiele je Sprache, IDE:
- Python: https://docs.python.org/dev/
- C: https://en.cppreference.com/c/language
